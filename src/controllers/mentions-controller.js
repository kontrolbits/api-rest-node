...
exports.createMention = async (req, res) => {
    ...
    try {
      ...
      return res.status(500).send({message: 'Falha ao cadastrar a menção.' + e});
    }
  };
  ...
  exports.updateMention = async (req, res) => {
    ...
    try {
      ...
      return res.status(500).send({message: 'Falha ao atualizar a menção.' + e});
    }
  };
  ...
  exports.deleteMention = async (req, res) => {
    try {
        ...
        res.status(500).send({message: 'Falha ao remover a menção.' + e});
    }
  };